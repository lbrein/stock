...
def _example_stock_quote(quote_ctx):
    ...
    """
    stock_code_list = ["HK.00001","HK.00003", "HK.00700"]
...
def _example_cur_kline(quote_ctx):
    ...
    stock_code_list = ["SZ.159901", "SZ.159902"]
    sub_type_list = ['K_15M']
    ...
    for code in stock_code_list:
        for ktype in sub_type_list:
            ret_code, ret_data = quote_ctx.get_cur_kline(code, 321, ktype)
