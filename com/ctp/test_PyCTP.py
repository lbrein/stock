...
class PyCTP_Trader_API(PyCTP.CThostFtdcTraderApi):
    ...
    def Login(self, BrokerID, UserID, Password):
        ...
        aid = b'client_lbrein_1.0.1'
        aud = b'DROBXRSQ8729AM5Q'
        self.ReqAuthenticate(BrokerID, UserID, aid , aud)
...
def __main__():
    ...
    print('连接前置', trader.Connect(b'tcp://180.166.0.230:21405'))
    print('连接前置', market.Connect(b'tcp://180.166.0.230:21413'))
