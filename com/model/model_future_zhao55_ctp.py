...
# 期货混合交易模型
class model_future_zhao55(model_future_zhao):
    ...
    def __init__(self):
        ...
        self.methodName = 'zhao55'  # 策略名称
        self.volumeCalcType = 1  # 交易量计算类别,分别为40日最低 和 3倍ATR
    ...
    def orderCheck(self, cur, param):
        ...
        if isOpen == 0:
            ...
            if isRun:
                ...
                opt3 = (posMode[0] == self.relativeMethods[0] and posMode[1] == 1 and posMode[2] * isOpen > 0) # 同向持有系统1
