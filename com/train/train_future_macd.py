...
class train_future_macd(train_future_singleExpect):
    ...
    csvList = [
        "MA_30_2.0_15_5_0.25_2.0",
        "JM_30_2.0_15_5_0.25_2.0",
        "RB_30_2.0_15_5_0.25_2.0",
        "MA_30_2.0_30_5_0.25_2.0",
        "JM_30_2.0_30_5_0.25_2.0",
        "RB_30_2.0_30_5_0.25_2.0",
        "SM_30_2.0_15_5_0.25_2.0",
        "SM_30_2.0_30_5_0.25_2.0"
    ]
    ...
    def total(self, dfs, dfs2=None, period=60):
        ...
        if self.isSimTickUse:
            ...
            # 近三分钟width变动
            df0["widthDelta"] = wd1 = width - width.shift(1)
            ...
            df0["macd2d"] = ma2d / ma2d.abs().mean() #归一化处理
        ...
        for i in range(period, len(df0)):
            ...
            if isPoint != 0 and isPoint * status <= 0:
                ...
                if isOpen == 0 and status * macd2dm > 0  :
                    ...
                    # 平仓
                elif isOpen != 0 and status * macd2dm < 0 and mastd < 3:
